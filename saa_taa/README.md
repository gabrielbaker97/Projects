...
![alt text](https://github.com/gabrielbaker97/quantitative-finance-analysis/blob/main/saa_taa/results/taa_vs_strategic.png)

Over the full 2002–2026 period, TAA does not outperform a simple 60/40 on raw returns. The cumulative growth chart shows 60/40 growing faster from 2014 onward, driven by sustained US equity outperformance. However, the TAA portfolio navigates the 2008–2009 GFC with a maximum drawdown of just −10%, compared to −47% for equal-weighted and −29% for 60/40. An investor who cannot tolerate large drawdowns or who cannot stay invested through a −30% loss benefits from TAA even when raw returns lag. Investors who cannot tolerate large drawdowns benefit from TAA even when raw returns 
lag. The strategy trades return potential for a significantly reduction in volatility and drawdown risk.
